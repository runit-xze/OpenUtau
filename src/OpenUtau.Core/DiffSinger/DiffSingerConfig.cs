...
namespace OpenUtau.Core.DiffSinger {
	...
	public class DsConfig {
		...
		[YamlMember(Alias = "use_shallow_diffusion")] public bool? _use_shallow_diffusion;
		[YamlMember(Alias = "use_variable_depth")] public bool? _use_variable_depth;
		[YamlIgnore]
		public bool useVariableDepth {
			get {
				// coalesce _use_depth and _use_shallow_diffusion
				if (_use_variable_depth.HasValue) {
					return _use_variable_depth.Value;
				}
				if (_use_shallow_diffusion.HasValue) {
					return _use_shallow_diffusion.Value;
				}
				return false;
			}
		}
		[YamlMember(Alias = "max_depth")] public double _max_depth;
		[YamlIgnore] public double maxDepth => useContinuousAcceleration ? _max_depth : _max_depth / 1000.0;
		public string dur;
