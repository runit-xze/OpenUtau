...
namespace OpenUtau.Core.Ustx {
	...
	public class UExpressionDescriptor : IEquatable<UExpressionDescriptor> {
		...
		public float? _custom_default_value = null; // made public for inclusion in YAML
		public bool isFlag;
		public string flag;
		...
		public float CustomDefaultValue {
			get => _custom_default_value ?? defaultValue;
			set {
				if (value == defaultValue) {
					_custom_default_value = null;
				} else {
					_custom_default_value = value;
				}
			}
		}
