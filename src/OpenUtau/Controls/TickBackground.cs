...
namespace OpenUtau.App.Controls {
	class TickBackground : TemplatedControl {
		...
		public double TickWidth {
			get => _tick_width;
			private set => SetAndRaise(TickWidthProperty, ref _tick_width, value);
		}
		public double TickOffset {
			get => _tick_offset;
			private set => SetAndRaise(TickOffsetProperty, ref _tick_offset, value);
		}
		public int TickOrigin {
			get => _tick_origin;
			private set => SetAndRaise(TickOriginProperty, ref _tick_origin, value);
		}
		public int SnapDiv {
			get => _snap_div;
			set => SetAndRaise(SnapDivProperty, ref _snap_div, value);
		}
		public ObservableCollection<int>? SnapTicks {
			get => _snap_ticks;
			set => SetAndRaise(SnapTicksProperty, ref _snap_ticks, value);
		}
		public bool ShowBar {
			get => _show_bar;
			set => SetAndRaise(ShowBarProperty, ref _show_bar, value);
		}

		private int _resolution = 480;
		private double _tick_width;
		private double _tick_offset;
		private int _tick_origin;
		private int _snap_div;
		private ObservableCollection<int>? _snap_ticks;
		private bool _show_bar = true;
