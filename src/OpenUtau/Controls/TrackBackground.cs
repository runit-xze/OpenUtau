...
namespace OpenUtau.App.Controls {
	class TrackBackground : TemplatedControl {
		...
		public double TrackHeight {
			get => _track_height;
			private set => SetAndRaise(TrackHeightProperty, ref _track_height, value);
		}
		public double TrackOffset {
			get => _track_offset;
			private set => SetAndRaise(TrackOffsetProperty, ref _track_offset, value);
		}
		public bool IsPianoRoll {
			get => _is_piano_roll;
			set => SetAndRaise(IsPianoRollProperty, ref _is_piano_roll, value);
		}
		public bool IsKeyboard {
			get => _is_keyboard;
			set => SetAndRaise(IsPianoRollProperty, ref _is_keyboard, value);
		}
		public int Key {
			get => _key;
		...
		private double _track_height;
		private double _track_offset;
		private bool _is_piano_roll;
		private bool _is_keyboard;
		private int _key;
